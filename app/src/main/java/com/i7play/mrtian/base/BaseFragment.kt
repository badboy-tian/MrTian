...
import com.i7play.mrtian.R
import com.i7play.mrtian.beans.BaseBean
import com.i7play.mrtian.utils.AppConstants
import com.i7play.mrtian.utils.DensityUtil
...
abstract class BaseFragment : Fragment() {
    ...
    protected fun jumpForResult(cls: Class<*>, requestCode: Int, fromCode: Int) {
        val i = Intent(context, cls)
        i.putExtra(AppConstants.FromCodeKey, fromCode)
        startActivityForResult(i, requestCode)
    }
